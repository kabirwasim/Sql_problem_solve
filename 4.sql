...
-- Insert values into the customers table 2 
INSERT INTO customer_2 (customer_id, customer_name, age, gender)
VALUES
    (1, 'John Doe', 30, 'Male'),
...
-- Insert values into the orders table 2
INSERT INTO order_2 (order_id, customer_id, order_date, total_amount)
VALUES
...
SELECT
      EXTRACT(MONTH FROM order_date) as month_nm,
	  SUM(quantity * price_per_unit) as sale_revenue
FROM sales
